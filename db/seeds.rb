...
david = User.create!(email: 'david.mambou@gmail.com', name: 'David', password: psw, password_confirmation: psw, admin: true, approved: true, goal: goal1, age: 30, routine: rtn)
